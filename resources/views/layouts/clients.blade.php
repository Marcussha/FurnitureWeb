...
<head>
    ...
    <!-- site metas -->
    <title>@yield('title', 'Your Title')</title>
        ...
        <div class="header_top">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <div class="full">
                            <span class="toggle_icon" style="cursor:pointer" onclick="openNav()"><img src={{ asset('img/menu_icon.png') }} alt="#" /></span>
                    ...
                    <div class="col-md-8">
                        <div class="float-right">
                            <ul class="top_links">
                                <li><a href="{{route('login')}}"><img src={{ asset('images/profile_icon.png') }} alt="Profile" /></a></li>
                                <li><a href="{{url('cart')}}"><img src={{ asset('images/cart.jpg') }} alt="New Icon" /></a></li>
                                <li class="searchbar">
                                    <input class="search_input" type="text" name="" placeholder="Search...">
                                    <a href="#" class="search_icon"><img src={{ asset('images/search_icon.png') }} alt="Search" /></a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <div id="inner_pade" class="banner-slider">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="full">
                        <h2>@yield('banner-title', 'Banner Title')</h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-sm-3">
                            ...
                            <ul class="footer_link_intas list-unstyled">
                                <li>
                                <span><img src={{ asset("images/f_in_blog.png")}} alt="Instagram Image 1" /></span>
                                <span>Consectetur Adipiscing</span>
                                </li>
                                <li>
                                <span><img src={{ asset("images/f_in_blog2.png")}} alt="Instagram Image 2" /></span>
                                <span>Consectetur Adipiscing</span>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="full text_align_center">
                        <p>© 2024 All Rights Reserved. <a href="https://html.design">html.design</a></p>
                    </div>
                </div>
            </div>
        </div>
